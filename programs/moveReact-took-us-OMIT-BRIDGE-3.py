...
while(1):
    ...
    down_puntoIzquierda = img_array[  (17.0/24.0) * yarp_height , 45  ]   # 45
    down_puntoCentro = img_array[ (17.0/24.0) * yarp_height , 187 ]  
    down_puntoDerecha = img_array[ (17.0/24.0) * yarp_height , 285  ]  # 285
    ...
    if (down_puntoDerecha < 700) or (down_puntoDerecha == 0):
            ...
            yarp.Time.delay(0.3)  # 90 degrees ;; 0.2
            robot.stopMovement() # optional
...
#            yarp.Time.delay(0.2)  # 90 degrees
            ...
            print "advance2"
            robot.moveForward(25) # ;; was 20
            yarp.Time.delay(0.9)  # 90 degrees;;; was 0.5
            robot.moveForward(10) # ;; was 20
            yarp.Time.delay(0.1)  # 90 degrees;;; was 0.5
            robot.stopMovement() # optional
